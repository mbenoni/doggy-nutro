    ...
    <section>
      ...
      <div className="box box--step3">
        <div className="box__content">
          ...
          <p>Din hund vil nyte godt av <strong>DoggyNutro {product}</strong>! Næringsinnholdet i dette fôret vil gi hunden din nøyaktig det den trenger.</p>
        ...
        <img
          ...
          alt={`Produktemballasje for DoggyNutro ${product}`}
        />
      </div>
    </section>
  );
